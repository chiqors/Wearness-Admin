...
<div class="col-6 col-md-8">
    <h1><span>Category project</span> Table</h1>
    <p>Hi {{ Auth::user()->name }}, this is category project table</p>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalAddLabel">Add category project</h5>
...
<div class="modal fade text-dark" id="modalInformation" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Category project</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script type="text/javascript">    
    ...
    $(document).ready(function() {
      const dataTable = $('.dataTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route("category-project.create") !!}',
        columns: [
    ...
    if($('#addForm').valid()){     
      ...
      ajax('/category-project', data, null, dataTable)
      $('#modalAdd').modal('hide')      
    }
    })
    ...
    $('.edit').on('click', (e) => {
        ...
        if ($('#editForm').valid()) {
            ...
            ajax('/category-project/updated/', data, null, dataTable)
        }
    ...
    $('.delete').on('click', (e) => {
      ...
      ajax('/category-project/'+id[0], ids, 'PUT', dataTable)
