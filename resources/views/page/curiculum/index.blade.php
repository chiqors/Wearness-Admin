...
<div class="col-6 col-md-8">
    <h1><span>Curiculum</span> Table</h1>
    <p>Hi {{ Auth::user()->name }}, this is Curiculum table</p>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditLabel">Edit curiculum</h5>
...
<div class="modal fade text-dark" id="modalPdf" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Curiculum</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script type="text/javascript">    
      ...
      const dataTable = $('.dataTable').DataTable({
        ...
        { data: 'file',
          ...
          render: function (data) {            
            ...
            return "<button class='btn btn-primary' onClick='pdfClick(\"/curiculums/extra/"+data+"/index.html\")'>File</button>";
          }
        },        
        ],
        select: true,              
    ...
    $('.edit').on('click', (e) => {
        ...
        if ($('#editForm').valid()) {
          ...
          if ($('#fileEdit').val() == "") {            
            ajax('/curiculum', data, null, dataTable)
          }else {
